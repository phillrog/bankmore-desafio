...
using BankMore.Services.Api.Transferencias;
using BankMore.Services.Api.Transferencias.Configurations;
using BankMore.Services.Api.Transferencias.Controllers.V1;
...
// ----- Swagger UI -----
builder.Services.AddCustomizedSwagger(builder.Environment, apiNome, typeof(TransferenciaController));
